...
function CartSummary() {
  ...
  return (
    ...
    <h4 className="text-center" style={{color:"#8d3d5b"}}>Rezime korpe</h4>
          ...
          >
            ...
            <div className="p-2 mx-3" style={{ width: "100%" }}>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <h4>{(cartItem.quantity! * cartItem.menuItem!.price).toFixed(2)} RSD</h4>
              </div>
              <div className="flex-fill">
                <h4 className="text-danger">{cartItem.menuItem!.price} RSD</h4>
              </div>
              <div className="d-flex justify-content-between">
                ...
                <button className="btn btn-danger mx-1"
                  onClick={() => handleQuantity(0, cartItem)}>Ukloni</button>
              </div>
            </div>
          </div>
        ))}
